...
<title> Question Update Form</title>
</head>
<body class="al">

	<div class="style">
		<form:form action="saveupdatequestion" modelAttribute="question">
			...
			<br></br>
			<input type="submit" value="Add Question" class="btn btn-primary" onclick="alert('Question Successfully updated')"/> 
		</form:form><br></br>
